...
server.registerTool("resolve_guides", {
    title: "Resolve Guides",
    description: "작업 설명과 수정 경로를 바탕으로 지금 읽어야 할 프론트엔드 가이드를 우선순위와 함께 반환합니다.",
    inputSchema: {
        task: z
            .string()
            .min(1)
...
server.registerTool("read_guide", {
    title: "Read Guide",
    description: "선택한 guide id의 본문, source path 목록, source 존재 여부, 마지막 갱신 기준을 반환합니다.",
    inputSchema: {
        id: z
            .enum(listGuideIds())
